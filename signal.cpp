...
extern std::atomic<bool>	pid_vector_main_bool;
extern std::atomic<bool>	pid_vector_second_bool;
...
void	force_switch_signal_handler(int sign)
{
	...
	pid_vector_second_bool = !pid_vector_second_bool;
	pid_vector_main_bool = !pid_vector_main_bool;
